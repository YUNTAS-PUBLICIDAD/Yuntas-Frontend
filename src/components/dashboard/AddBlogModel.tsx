...
const AddBlogModal = ({
  ...
  const handleInsertManualLink = () => {
    ...
    const linkedText = `<a href="${linkUrl}" target="_blank" rel="noopener noreferrer" title="${selectedText}" style="color: white; font-weight: bold; font-style: italic; text-decoration: underline;">${selectedText}</a>`;
  ...
  const handleInsertProductLink = (producto: Producto) => {
    ...
    const linkedText = `<a href="/products/producto/?link=${link}" style="color: white; font-weight: bold; font-style: italic; text-decoration: underline;" title="${link}">${selectedText}</a>`;
