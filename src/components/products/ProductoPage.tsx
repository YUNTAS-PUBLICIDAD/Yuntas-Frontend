    ...
    <div className="w-full">
      ...
      <div className="bg-indigo-950 py-12 lg:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="mx-auto w-full max-w-md lg:max-w-full aspect-[1/1] overflow-hidden flex items-center justify-center">
              <img
                id="product-viewer"
                src={
                  data.imagenes &&
            ...
            <div className="order-1 lg:order-2 text-white text-center lg:text-left flex flex-col justify-center items-center lg:items-start px-4 sm:px-0">
      ...
      <div className="bg-indigo-950 py-12 lg:py-20">
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
          >
            <div className="text-white text-center lg:text-left flex flex-col justify-center items-center lg:items-start px-4 sm:px-0">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 text-center lg:text-left">
                Beneficios:
              </h2>
              <div className="space-y-4">
