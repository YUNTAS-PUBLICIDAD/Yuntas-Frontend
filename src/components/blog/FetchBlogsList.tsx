  ...
  return (
    <div className="min-h-screen py-16 bg-white">
      ...
      <div className="w-full bg-[#2DCCFF]
       ...
       items-center justify-center gap-8 mb-12 shadow-md"> 
  
        <h2 className="text-white text-5xl md:text-5xl font-bold uppercase tracking-wide leading-tight"> 
          DESCUBRE MÁS SOBRE NUESTROS PRODUCTOS
        </h2>

        {allBlogs.length > 0 && (
          <div className="w-full max-w-4/12"> {/* Limit the width of the search bar */}
          ...
          >
            {currentBlogs.length > 0 ? (
              ...
              <div className="text-center py-16">
                <div className="bg-white rounded-2xl p-12 max-w-lg mx-auto">
                  <svg
