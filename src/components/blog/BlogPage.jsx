    ...
    <>
      ...
      <section className="bg-[#F7FAFB] text-[#1A1A1A] font-montserrat">
        <div className="relative z-10 w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-0">
          ...
          {/* Imagen + tarjeta */}
          <div className="relative flex flex-col md:flex-row items-center justify-center w-full bg-blue-900/85 py-16 overflow-hidden rounded-none h-auto md:h-[750px]">
            {/* Imagen desplazada */}
